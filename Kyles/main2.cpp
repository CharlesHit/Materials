...
void initGLUT(int argc, char** argv, Options& window) {
	glutInit(&argc, argv);
...
int main(int argc, char **argv)
{
	...
	sph1->diffuseColor = Vec3f(0.6, 0, 0.8);
	Sphere *sph2 = new Sphere(Vec3f(0.5, -1, -8), 1.5);
	sph2->ior = 1.5;
	sph2->materialType = REFLECTION_AND_REFRACTION;

	Sphere *sph3 = new Sphere(Vec3f(1.5, 0, -10), 1);
	sph3->ior = 4;
